...
while True:
    ...
    if "covid update for" in InputFromUser:
        ...
        print(">" + "My name is Clone , A virtual assistant.Pleased to meet you !")
        engine.say("My name is Clone , A virtual assistant Pleased to meet you !")
        engine.runAndWait()
    elif "who created you" in InputFromUser:
        print("I was created by EliteCloneTrooper_YT , A Python Programmer.He toiled day and night for my creation")
        engine.say("I was created by EliteCloneTrooper_YT , A Python Programmer ,, He toiled day and night for my creation")
        engine.runAndWait()
